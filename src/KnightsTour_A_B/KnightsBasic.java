package KnightsTour_A_B;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.Scanner;

public class KnightsBasic {
    ...
    public KnightsBasic(){
        //prompts user to enter the starting position of the knight
        System.out.println("\nEnter the starting row number between 0-7: ");
        locRow=scan.nextInt();
        System.out.println("\nEnter the starting column number between 0-7: ");
        locCol=scan.nextInt();
